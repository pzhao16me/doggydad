---
title: John Hopcroft & Robert Tarjan：他们让图算法达到了理论极限，用数据结构改变了编程的效率边界
date: 1986-01-01
description: John Hopcroft & Robert Tarjan：他们让图算法达到了理论极限，用数据结构改变了编程的效率边界
tags: [图灵奖, 计算机历史, 编程语言, 算法, 数据库]
---
